...
//    lineSnap(params.fetch1LineSnapWidth),   // cache-line start address alignment
//    maxLineWidth(params.fetch1LineWidth),   // max fetch width in bytes 
//    fetchLimit(params.fetch1FetchLimit),    // no. of fetches allowed in flight not reqd just =1
